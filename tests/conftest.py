...
# WARNING: Ensure imports from `net_worth_tracker` comes after this line
from net_worth_tracker import app, settings, db  # noqa
from net_worth_tracker.cli import create_user, cli  # noqa
